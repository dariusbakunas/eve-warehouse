...
const SkillsIcon = (props: SvgIconProps) => {
  return (
    <SvgIcon {...props} viewBox="0 0 110.25 131.56">
      <defs>
        <clipPath id="bffbd91f-2356-4f15-82d3-c181ae961a2f" transform="translate(-42.87 -31.43)">
          <rect width="196" height="196" style={{ fill: 'none' }} />
        </clipPath>
        <clipPath id="ba15f342-7389-413b-b25c-f71c5b39633e" transform="translate(-42.87 -31.43)">
          <rect x="42.88" y="31.43" width="110.25" height="119.19" style={{ fill: 'none' }} />
        </clipPath>
        <clipPath id="e6a35ee6-2a7d-4e6d-9f47-775578d8491e" transform="translate(-42.87 -31.43)">
          <polygon
        ...
        <clipPath id="b9ea3dc7-9809-4a37-ac84-1cbee69a3936" transform="translate(-42.87 -31.43)">
          <polygon points="56.8 52.02 42.88 52.02 42.88 163 131.57 163 131.57 52.02 56.8 52.02" style={{ fill: 'none' }} />
        </clipPath>
        <linearGradient
      ...
      <g style={{ clipPath: 'url(#bffbd91f-2356-4f15-82d3-c181ae961a2f)' }}>
        <g style={{ clipPath: 'url(#bffbd91f-2356-4f15-82d3-c181ae961a2f)' }}>
          <path d="M131.57,163v0Z" transform="translate(-42.87 -31.43)" style={{ fill: '#fff' }} />
          <g style={{ clipPath: 'url(#bffbd91f-2356-4f15-82d3-c181ae961a2f)' }}>
            <g style={{ opacity: 0.5 }}>
              <g
                style={{
          ...
          <g style={{ clipPath: 'url(#b9ea3dc7-9809-4a37-ac84-1cbee69a3936)' }}>
            <rect y="20.58" width="88.69" height="110.98" style={{ fill: 'url(#b7c070ae-6d22-4395-85ac-01aaf2dcf53d)' }} />
          </g>
        </g>
      </g>
    </SvgIcon>
