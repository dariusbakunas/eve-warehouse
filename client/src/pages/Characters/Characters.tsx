...
export const Characters: React.FC = () => {
  ...
  const [removeCharacter, { loading: characterRemovalLoading }] = useMutation<RemoveCharacter, RemoveCharacterVariables>(removeCharacterMutation, {
    onError: (error) => {
  ...
  const handleRemoveCharacter = useCallback(
    ...
    [showConfirmDialog, removeCharacter]
  );
  ...
  }, [location, addCharacter, enqueueNotification, updateCharacter]);
